...
export type McpZodTypeKind =
  (typeof McpZodTypeKind)[keyof typeof McpZodTypeKind];
...
function processCreateParams(params: RawCreateParams): ProcessedCreateParams {
  ...
  if (errorMap && (invalid_type_error || required_error)) {
    throw new Error(
      'Can not use both errorMap and invalid_type_error or required_error together'
    );
  }
  if (errorMap) {
